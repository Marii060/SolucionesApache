...
class ProveedorAdmin(admin.ModelAdmin):
    list_display = ('nombre', 'razon_social', 'identificacion', 'telefono', 'correo', 'activo')
    list_filter = ('activo',)
...
class ProductoAdmin(admin.ModelAdmin):
    ...
    # Busca por nombre y códigos
    search_fields = ('nombre', 'codigo_interno', 'codigo_barras')
    # permite seleccionar los proveedores de forma más cómoda en la relación Muchos a Muchos
